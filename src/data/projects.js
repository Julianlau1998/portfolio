export const projects = [
    {
        title: 'Recipe Finder',
        slug: 'recipe-finder',
        description: 'PWA for finding and discovering new recipes ',
        img: '/img/recipes/main.webp',
        images: [
            '/img/recipes/main.webp',
            '/img/recipes/2.webp',
            '/img/recipes/3.webp'
        ],
    ...
    },
    {
        ...
        description: 'Platform for finding explanations to any topic.',
        img: '/img/how_works/main.webp',
        images: [
            '/img/how_works/1.webp',
            '/img/how_works/2.webp',
            '/img/how_works/3.webp'
        ],
    ...
    },
    {
        ...
        slug: 'etf-calculator',
        description: 'PWA for calculating returns of your ETFs',
        img: '/img/etf/main.webp',
        images: [
            '/img/etf/main.webp',
            '/img/etf/3.webp',
            '/img/etf/2.webp'
    ...
    },
    {
        ...
        slug: 'finances-tracker',
        description: 'Keep track of all your personal finances',
        img: '/img/how_works/main.webp',
        images: [
            '/img/finances/main.webp',
            '/img/finances/3.webp',
            '/img/finances/2.webp'
        ],
    ...
    },
    {
        ...
        slug: 'type-the-alphabet',
        description: 'Game for measuring how fast you can type the alphabet',
        img: '/img/recipes/main.webp',
        images: [
            '/img/alphabet/main.webp',
            '/img/alphabet/3.webp',
            '/img/alphabet/2.webp'
        ],
    ...
    },
    {
        title: '.txt editor',
        slug: 'txt-editor',
        description: 'Simply import, edit and save your text files',
        img: '/img/etf/main.webp',
        images: [
            '/img/txt/main.webp',
            '/img/txt/3.webp',
